return {
        ...
        win = {
          input = {
            keys = {
              ...
              ["<C-Down>"] = { "history_forward", mode = { "n", "i" } },
              ["<C-j>"] = { "list_down", mode = { "n", "i" } },
              ["<C-k>"] = { "list_up", mode = { "n", "i" } },
              ["<A-u>"] = { "preview_scroll_up", mode = { "n", "i" } },
              ["<A-d>"] = { "preview_scroll_down", mode = { "n", "i" } },
    ...
    keys = {
      ...
      { "<Esc><Esc>", "<C-\\><C-n>", desc = "Exit terminal mode with double Esc", mode = "t" },
      { "<C-n>", "<C-n>", desc = "Terminal navigation down", mode = "t" },
      { "<C-p>", "<C-p>", desc = "Terminal navigation up", mode = "t" },
      -- Notification
