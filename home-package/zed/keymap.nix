[
  ...
  {
    "context" =
      "Editor && vim_mode != helix_normal && vim_operator == none && !VimWaiting";
    "bindings" = {
  ...
  }
  {
    ...
    "bindings" = {
      ...
      "shift-z shift-q" =
        [ "pane::CloseActiveItem" { "save_intent" = "skip"; } ];
      "shift-z shift-z" =
        [ "pane::CloseActiveItem" { "save_intent" = "save_all"; } ];
      # Count support
      "1" = [ "vim::Number" 1 ];
      "2" = [ "vim::Number" 2 ];
      "3" = [ "vim::Number" 3 ];
  ...
  {
    "context" =
      "Editor && VimControl && (vim_mode == helix_normal || vim_mode == visual) && !VimWaiting && !menu";
    "bindings" = {
